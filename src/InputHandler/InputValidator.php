...
class InputValidator
{
    ...
    private static $trowErrors = true;

    /**
     * @param bool $trowErrors
     */
    public static function setTrowErrors(bool $trowErrors): void{
        self::$trowErrors = $trowErrors;
    }

    /**
     * @return bool
     */
    public static function isTrowErrors(): bool{
        return self::$trowErrors;
    }
